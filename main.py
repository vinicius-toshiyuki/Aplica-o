...
from front.attempts import AttemptsScreen
from front.review import ReviewScreen
...
def main():
    ...
    app.add_handler('attempts', AttemptsScreen)
    app.add_handler('review', ReviewScreen)
